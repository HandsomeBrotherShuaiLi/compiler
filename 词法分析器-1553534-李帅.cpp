...
//	char ch2=*ptr;
//	token+=ch2;
//	if(ch1=='0'&&(ch2=='x'||ch2=='X'))//十六进制 
//	{
//		while (1)
//	{
//		*(++ptr) = fgetc(f);
//		if (isnumber(*ptr) != 1&&(*ptr!='.')&&(*ptr!=' '))//1a那么跳出，并且报错数字后面要有空格 
//			{
//				cout<<"数字输入错误"<<endl;//error
//				ferror=1;
//				break;
//			 } 
//		if(*ptr==' ')
...
//	else
//	{
//		if(ch2!='x'&&(isnumber(ch2)!=1)&&(ch2!='.')&&(ch2!='e')&&(ch2!='E')&&(ch2!=' '))
//		{
//			   cout<<"数字输入错误"<<endl;//error
//				ferror=1;
//			
...
//	{
//		*(++ptr) = fgetc(f);
//		if (isnumber(*ptr) != 1&&(*ptr!='.')&&(*ptr!='e')&&(*ptr!='E')&&(*ptr!=' '))//1a那么跳出，并且报错数字后面要有空格 
//			{
//				cout<<"数字输入错误"<<endl;//error
//				ferror=1;
//				break;
